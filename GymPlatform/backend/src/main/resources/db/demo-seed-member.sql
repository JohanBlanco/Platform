...
-- ---------------------------------------------------------------------------
-- Rutina activa de Luis (fuerza / hipertrofia)
-- ---------------------------------------------------------------------------
...
(2, 'Definición y cardio',
 ...
 6, 2, NULL, 1, FALSE, 3,
 CURRENT_DATE, DATEADD('MONTH', 1, CURRENT_DATE), 4, 'WEEKS',
 TRUE, CURRENT_TIMESTAMP);
...
-- Vincular solicitud de Luis como completada con la rutina
...
-- ---------------------------------------------------------------------------
-- Plan nutricional Luis (+ uno archivado corto para historial)
-- ---------------------------------------------------------------------------
...
(2, 1, 6, 2, 'Plan déficit suave',
 ...
 NULL,
 'ACTIVE', CURRENT_DATE, DATEADD('MONTH', 1, CURRENT_DATE), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
-- ---------------------------------------------------------------------------
-- Medidas corporales (historial para ver progreso)
-- ---------------------------------------------------------------------------
...
(1, 1, 5, 2,
 ...
 34.0, 34.5, 28.0, 28.5,
 56.0, 56.5, 37.0, 37.5,
 'Medición inicial de seguimiento', NULL, DATEADD('DAY', -45, CURRENT_TIMESTAMP)),
(2, 1, 5, 2,
 ...
 35.0, 35.5, 28.5, 29.0,
 57.0, 57.5, 37.5, 38.0,
 'Buen progreso en pecho y brazos', NULL, DATEADD('DAY', -15, CURRENT_TIMESTAMP)),
(3, 1, 5, 2,
...
(4, 1, 6, 2,
 ...
 28.0, 28.5, 23.0, 23.5,
 54.0, 54.5, 35.0, 35.0,
 'Inicio plan de definición', NULL, DATEADD('DAY', -20, CURRENT_TIMESTAMP)),
(5, 1, 6, 2,
 ...
 28.0, 28.0, 23.0, 23.0,
 53.5, 54.0, 34.5, 34.5,
 'Bajó cintura; mantener proteína', NULL, DATEADD('DAY', -3, CURRENT_TIMESTAMP));

-- Cita de nutrición de Patricia ya existe; una medida más no requiere update.

SET REFERENTIAL_INTEGRITY TRUE;

ALTER TABLE routines ALTER COLUMN id RESTART WITH 100;
ALTER TABLE routine_days ALTER COLUMN id RESTART WITH 100;
ALTER TABLE routine_exercises ALTER COLUMN id RESTART WITH 100;
ALTER TABLE nutrition_plans ALTER COLUMN id RESTART WITH 100;
ALTER TABLE nutrition_meals ALTER COLUMN id RESTART WITH 100;
ALTER TABLE nutrition_meal_items ALTER COLUMN id RESTART WITH 100;
ALTER TABLE body_measurements ALTER COLUMN id RESTART WITH 100;
