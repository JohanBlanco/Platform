...
const messages = {
  es: {
    ...
    'settings.gymProfileDescription': 'Nombre, contacto y color de marca. Requiere tu contraseña de administrador.',
    ...
    'settings.privateAccessDescription': 'Contraseña del administrador para ocultar secciones sensibles (estadísticas y otras que agregues después).',
  ...
  en: {
    ...
    'settings.gymProfileDescription': 'Name, contact and brand color. Requires your admin password.',
